#!/usr/bin/env python3
"""
comp5_large_n.py — Extend bad_frac + min_wfrac measurements to N=1000..2000
...
def main():
    N_list = [1000, 1100, 1200, 1300, 1400, 1500, 1700, 2000]

    # 100 trials for N ≤ 1400, 50 for N ≥ 1500 (safety margin for time budget)
    def n_trials(N):
        return 100 if N <= 1400 else 50

    t_global = time.time()
    summaries = []

    print("comp5_large_n: bad_frac + min_wfrac at N=1000..2000", flush=True)
